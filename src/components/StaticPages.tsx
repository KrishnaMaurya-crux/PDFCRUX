    ...
    >
      ...
      <Card>
        <CardContent className="p-6 sm:p-8">
          ...
          <div className="space-y-3">
            {[
              { q: "Is PdfCrux really free?", a: "Yes! All core PDF tools offer a generous free plan with daily limits. Premium unlocks unlimited usage, AI tools, cloud storage, and extra features for power users." },
