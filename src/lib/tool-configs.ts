...
export const toolConfigs: Record<string, ToolConfig> = {
  ...
  "pdf-to-word": {
    ...
    uploadSubtitle: "Create an editable Word document with professional layout reconstruction.",
    options: [
      {
        id: "use-ocr-space",
      ...
      },
      {
        ...
        type: "toggle",
        defaultValue: true,
        hint: "Use OCR for scanned pages with no selectable text.",
      },
      {
        id: "ocr-language",
        label: "OCR Language",
    ...
    processingSteps: ["Loading PDF...", "Rendering pages...", "OCR processing...", "Detecting layout...", "Reconstructing document..."],
    processButtonText: "Convert to Word",
    outputDescription: "Your PDF has been converted to an editable Word document.",
